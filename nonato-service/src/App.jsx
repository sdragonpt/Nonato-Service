...
const App = () => {
  ...
  return (
    <Router>
      <div
        className="App min-h-screen bg-gray-900 text-white bg-contain bg-no-repeat bg-center"
      ...
      >
        ...
        <div
          ref={navbarRef}
          className={`fixed top-0 left-0 w-64 h-full bg-gray-800 z-50 transform ${

...
const generateBudgetPDF = async (
  ...
  y -= 15; // Aumentado o espaçamento aqui
  ...
  y -= 10; // Aumentado o espaçamento aqui
  drawLine(initialX, page.getWidth() - margin);
  y -= 15; // Aumentado o espaçamento aqui
  ...
  selectedServices.forEach((service) => {
    ...
    y -= 5; // Move o cursor para baixo após o texto
    drawLine(initialX, page.getWidth() - margin); // Desenha a linha
    y -= 15; // Move o cursor para baixo após a linha para o próximo item
  });

...
const ManageServices = () => {
  ...
  const handleEquipmentChange = (e) => {
    ...
    if (selectedEquipment) {
      ...
      const filtered = equipments.filter(
        (equipment) => equipment.clientId === selectedEquipment.clientId
      );
      setFilteredEquipments(filtered);
    }
  };
  ...
  return (
    <div className="w-full xl:w-96 mx-auto p-4 bg-gray-800 rounded-lg">
            ...
            return (
              <div key={service.id} className="bg-gray-700 p-3 mb-2 rounded">
                <h4 className="text-white text-sm">
                  {service.serviceName} - {service.serviceValue} €
                </h4>
                ...
                {expandedService === service.id && (
                  <div className="mt-2 text-gray-300 text-xs">
                    <p>
                      <strong>Cliente:</strong> {client ? client.name : "N/A"}
                    </p>
                    <p>
